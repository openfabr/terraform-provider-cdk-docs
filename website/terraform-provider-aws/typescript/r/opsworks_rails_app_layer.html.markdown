...
# Resource: aws\_opsworks\_rails\_app\_layer
...
new aws.opsworksRailsAppLayer.OpsworksRailsAppLayer(this, "app", {
...
* `appServer` - (Optional) Keyword for the app server to use. Defaults to "apache\_passenger".
