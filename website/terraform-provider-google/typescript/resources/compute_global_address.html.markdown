...
*   `prefixLength` -
    ...
    or addressType=INTERNAL when purpose=PRIVATE\_SERVICE\_CONNECT
...
*   `purpose` -
    ...
    * VPC\_PEERING - for peer networks
    * PRIVATE\_SERVICE\_CONNECT - for ([Beta](https://terraform.io/docs/providers/google/guides/provider_versions.html) only) Private Service Connect networks
