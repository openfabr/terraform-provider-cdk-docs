...
# azurerm\_hdinsight\_hadoop\_cluster
...
const azurermHdinsightHadoopClusterExample =
  new azurerm.hdinsightHadoopCluster.HdinsightHadoopCluster(this, "example_3", {
    cluster_version: "3.6",
    component_version: [
      {
        hadoop: "2.7",
...
HDInsight Hadoop Clusters can be imported using the `resourceId`, e.g.
